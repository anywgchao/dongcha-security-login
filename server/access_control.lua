...
redis_module.get_red(
    ...
    function (success , red)
		...
		-- redis write value
			--[[local ok, err = red:set("hello_callback", ngx.var.http_issbrowsertoken)
			if not ok then
